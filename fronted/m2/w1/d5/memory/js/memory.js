...
var interval;
var findIcons = document.getElementsByClassName("find");
...
function startGame() {
  ...
  for (var i = 0; i < 24; i++) {
    ...
    document.getElementById('griglia').appendChild(boxCarta).appendChild(element);
...
//(per ottimizzare il codice queste due le ho fatte insieme)
function playAgain() {
